              ...
              <AnimatePresence>
                {open && (
                  <Listbox.Options
                    ...
                    className="w-42 absolute right-0 z-10 mt-2 max-h-60 origin-top-right overflow-auto rounded-xl border border-secondary bg-primary p-2 text-base capitalize shadow-lg focus:outline-none sm:text-sm"
