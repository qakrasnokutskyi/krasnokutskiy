...
>
  ...
  <div className="absolute bottom-4 left-4 flex flex-col rounded-lg bg-neutral-100/75 px-4 py-2 leading-none backdrop-blur dark:bg-neutral-900/75 md:bottom-6 md:left-6">
    ...
    <p className="m-0 text-lg font-semibold text-primary">Zaporizhzha, Ukraine</p>
  </div>
</div>

<figcaption>
  City of Ukraine in the evening. This is a use of the twilight theme. This is true
  beautiful and rich in detail. Later we will see how to control the lighting and make
  The map is dynamic.
</figcaption>
...
<div
  ...
  style={{ height: "300px" }}
>
  <div className="absolute bottom-4 left-4 flex flex flex-col rounded-lg border border-primary bg-neutral-100/75 px-4 py-2 leading-none backdrop-blur dark:bg-neutral-900/75 md:bottom-6 md:left-6">
    <p className="m-0 text-sm font-medium text-secondary">Location</p>
